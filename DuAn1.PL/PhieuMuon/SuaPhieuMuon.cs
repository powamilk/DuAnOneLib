...
{
    public partial class SuaPhieuMuon : Form
    {
        ...
        {
            if (MessageBoxExtension.Confirm("Bạn có chắc chắn muốn cập nhật phiếu mượn?"))
            {
                DateTime ngayMuon;
                DateTime ngayTra;
                ...
                // Tạo đối tượng cập nhật phiếu mượn
                ...
                var result = _phieuMuonService.Update(phieuMuonUpdate);
                bool isSuccess = result.Equals("Cập nhật phiếu mượn thành công.", StringComparison.OrdinalIgnoreCase);

                // Hiển thị thông báo kết quả
                MessageBoxExtension.Notification("CẬP NHẬT", result);
